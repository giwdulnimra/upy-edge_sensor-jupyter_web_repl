...
#scp "${RemoteUser}@${RemoteHost}:/home/${RemoteUser}/micropython/ports/rp2/${BuildDirectory}/*.ld" "${LocalBaseDir}/build/${BuildDirectory}/"
#scp "${RemoteUser}@${RemoteHost}:/home/${RemoteUser}/micropython/ports/rp2/${BuildDirectory}/*.log" "${LocalBaseDir}/build/${BuildDirectory}/"
